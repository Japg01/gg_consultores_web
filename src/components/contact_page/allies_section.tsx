    ...
    >
      ...
      <div className="relative z-10 container mx-auto flex flex-col md:flex-col lg:flex-row items-start justify-between gap-10">
        <div className="w-full lg:w-[55%] flex flex-col md:pl-2">
          <h2 className="text-3xl md:text-4xl font-poppins-bold text-[#0f172a] mb-8">
          ...
          <div className="mb-12 relative z-20">
            <h3 className="text-xl md:text-2xl font-semibold text-[#0f172a] mb-10 text-center w-full">
              ...
              {[
                ...
                <img
                  ...
                  className={`${getAnimationClass(
                    i
                  )} w-44 h-44 md:w-48 md:h-48 rounded-full object-contain bg-white p-4 shadow-md`}
                />
              ))}
            </div>
          </div>
